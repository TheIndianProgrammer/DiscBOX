...
#======================MY_RIG_MAIN=========================
    ...
    #====================DATA-ACCSES-FEED========================
    with open("database//mainshopforbuy.json", "r") as f:
            mainshop_for_buy = json.load(f)

    with open("database//mainshopforshop.json", "r") as f2:
...
bot.run("ODYyNjEzOTg1MjY1NTgyMDgx.YOa54A.RHcaWNRotlAjS9-NB33KRDXEU_g")